      ...
      <div className="container">
        <div className="top">
          ...
          <div className="item">
            ...
            <span>SSM Select</span>
            <span>ClearVoice</span>
            <span>SSM Workspace</span>
            <span>Learn</span>
        ...
        <div className="bottom">
          ...
          <div className="right">
            <div className="social">
              ...
              <img src="./public/icons/pinterest.png" alt="" />
              <img src="./public/icons/instagram.png" alt="" />
            </div>
            <div className="link">
              <img src="./public/icons/language.png" alt="" />
              <span>English</span>
            </div>
            <div className="link">
              <img src="./public/icons/rupee1.png" alt="" />
              <span>INR</span>
            </div>
            <img src="./public/icons/accessibility.png" alt="" />
          </div>
        </div>
      </div>
    </div>
